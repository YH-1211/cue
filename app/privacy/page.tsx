  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6 sm:py-12">
      ...
      <article className="flex flex-col gap-6">
        ...
        <Section title="8. 退会・開示・訂正・削除等の請求">
          利用者は、いつでも本サービスから退会し、自己のアカウントおよび関連データを削除できます。退会は、ログイン後の「プロフィール編集」画面にある「退会（アカウント削除）」から利用者自身の操作で行えます。退会すると、アカウント情報・プロフィール・保存した内容・投稿やコメントなどの関連データは削除され、元に戻すことはできません（法令に基づき一定期間保存が必要な記録を除きます）。
          <br />
          <br />
